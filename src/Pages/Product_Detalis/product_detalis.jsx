...
function ProductDetalis(props) {
    ...
    useEffect(() => { 
        ...
        axios.get(`https://lazy-jade-goat-wear.cyclic.app//products/${productId}`,
        {
            headers: {
        ...
        axios.get(`https://lazy-jade-goat-wear.cyclic.app//products/${productId}/reviews`)
        .then(res =>{
    ...
    const addToCartHandler = () => {
        ...
        if (user.userInfo) {
            ...
            axios.post('https://lazy-jade-goat-wear.cyclic.app//carts/',prd,{
                headers: {
                  'content-type': 'application/json',
                  'authorization':token
                }
    ...
    const delReview = ()=>{
    const token = localStorage.getItem("token");
        axios.delete(`https://lazy-jade-goat-wear.cyclic.app//reviews/${UserReviewId}`,
        {
            headers: {
              'content-type': 'application/json',
              'authorization':token
