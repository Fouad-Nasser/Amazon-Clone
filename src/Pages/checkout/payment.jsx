                ...
                onApprove(data,actions){
                    return actions.order.capture().then(detalis=>{
                        ...
                        if (detalis.status === "COMPLETED") {
                            ...
                            axios.put(`https://lazy-jade-goat-wear.cyclic.app//orders/${order._id}`, {isPaid:true} ,{
                            headers: {
        ...
        <>
            ...
            <div class="row">
                ...
                <div class="col-10 col-md-8 mx-auto my-5 p-5 shadow-lg">
                    ...
                    <h4>Select Method</h4>
                    <button className='btn btn-primary mb-3 w-100' onClick={()=>{navigate('/Order')}}>Pay Cash</button>
