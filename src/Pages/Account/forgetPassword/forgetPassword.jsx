...
const ForgetPassword = () => {
  ...
  const handleButtonClick1 = () => {
    ...
    axios
      .post(
        "https://lazy-jade-goat-wear.cyclic.app//users/forgot_password",
        {
  ...
  const handleButtonClick2 = () => {
    ...
    axios
      .post(
        "https://lazy-jade-goat-wear.cyclic.app//users/verify_reset_code",
        {
          email: emailVal,
  ...
  const handleButtonClick3 = () => {
    ...
    axios
      .put(
        "https://lazy-jade-goat-wear.cyclic.app//users/reset_password",
        {
          email: emailVal,
