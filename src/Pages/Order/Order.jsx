...
const Order = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://lazy-jade-goat-wear.cyclic.app//orders?user=6416d0c1792b554cdcf54953&page=${page}&limit=${limit}`,
        {
          headers: {
  ...
  const handleSearch = () => {
    axios
      .get(
        `https://lazy-jade-goat-wear.cyclic.app//orders?user=6416d0c1792b554cdcf54953&[keyword]=${searchVal?.current?.value}`,
        {
          headers: {
            "content-type": "application/json",
            Authorization: localStorage.getItem("token"),
